" -----------------------------------------------------------------------------
" Name:         Lego
" Description:  Intense Pastel Color Scheme for Vim
" Author:       Josep Mª Domingo Catafal <jdomingocatafal@gmail.com>
" Website:      https://github.com/josepmdc/lego
" License:      MIT
" -----------------------------------------------------------------------------
...
let g:colors_name = 'lego'
" }}}
" Configuration: {{{
let s:configuration = {}
let s:configuration.palette = get(g:, 'lego_palette', 'soft')
let s:configuration.transparent_background = get(g:, 'lego_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'lego_disable_italic_comment', 0)
let s:configuration.enable_italic = get(g:, 'lego_enable_italic', 0)
let s:configuration.cursor = get(g:, 'lego_cursor', 'auto')
let s:configuration.current_word = get(g:, 'lego_current_word', get(g:, 'lego_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}
" Palette: {{{
let s:palette = {
      ...
      \ 'fg':         ['#bab7a9',   '223',  'White'],
      \ 'red':        ['#e87475',   '167',  'Red'],
      \ 'orange':     ['#e08b67',   '208',  'Red'],
      \ 'yellow':     ['#f7be4c',   '214',  'Yellow'],
      \ 'green':      ['#80ba80',   '108',  'Green'],
      \ 'cyan':       ['#87c095',   '108',  'Cyan'],
      \ 'blue':       ['#6ea6d1',   '109',  'Blue'],
      \ 'purple':     ['#d18ae2',   '175',  'Magenta'],
...
if s:configuration.disable_italic_comment
  ...
  call s:HL('Todo', s:palette.yellow, s:palette.none)
else
